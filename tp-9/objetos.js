...
function sinDocumento(persona) {
    const nuevaPersona = { ...persona }; // se crea una copia 
...
function tieneDocumento(persona) {
    return "documento" in persona; // El operador `in` verifica si una propiedad existe en un objeto (o en su cadena de prototipos). 
}
console.log("resultado tieneDocumento: ", tieneDocumento(personaEjemplo));
console.log("resultado tieneDocumento (sin documento): ", tieneDocumento(sinDocumento(personaEjemplo)));
...
console.log("resultado sonLaMismaPersona (diferentes documentos): ", sonLaMismaPersona(
    personaEjemplo,
    { apellido: "Lopez", nombre: "Maria", edad: 30, documento: 67890 }
));
...
function personaMasGrande(persona1, persona2) {
    // Comparamos la propiedad 'edad' de ambos objetos.
